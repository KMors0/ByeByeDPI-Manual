...
> [!CAUTION]
> Дальше вас ждёт поле ИИшного кода. Напомню - подобный код не проверяется человеком, что может привести к наличию проблем с безопасностью и нестабильностью. Любые претензии адресуйте авторам проектов.
> Скачивайте приложения на свой страх и риск.

- SwByeDPI
  Проект от mlwr, использует byedpi как движок, следовательно стратегии из ByeByeDPI будут совместимы (при соответствии версий byedpi). Ссылка [тут](https://github.com/mIwr/SwByeDPI)

- Spoofy
  Проект от ringolol, использует spoofdpi. Ссылка [тут](https://github.com/ringolol/Spoofy)
