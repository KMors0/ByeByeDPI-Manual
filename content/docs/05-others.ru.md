...
Появился также [SwByeDPI](https://github.com/mIwr/SwByeDPI) от mlwr. Важно обозначить, что проект является вайбкодом, поэтому использовать как основное средство обхода DPI не рекомендуется (есть вопросы к стабильности проекта). 
