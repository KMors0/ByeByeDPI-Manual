...
25. [Не работает YouTube только на Android TV](#not-working-YT-only-on-TV)
...
## <a id="not-working-YT-only-on-TV">25. Не работает YouTube только на Android TV</a>

Проблема может быть где угодно

1. Проверьте доступ к самому сайту
   
   Перейдите в браузер и откройте `youtube.com`

   Если сайт не открылся, то попробуйте другую стратегию

2. Проверьте сам клиент
  ...
  Найдите и откройте там "YouTube"

  Отчистите приложение

  Если не помогло: попробуйте его обновить

  3. Использование сторонних клиентов

  Попробуйте другие клиенты, например, [SmartTube](https://github.com/yuliskov/SmartTube/releases) или [TizenTube Cobalt](https://github.com/reisxd/TizenTubeCobalt/releases)

  4. Проверьте доступ к интернету

    Возможно, вы накосячили с настройками сети.