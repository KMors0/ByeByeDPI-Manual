...
Теперь вы можете вставить в стратегию к файлу.

Пример: `-f1 -Qm=512 -l:/storage/emulated/0/downloads/g.bin`

Здесь указан путь к файлу `g.bin`, который находится в `downloads`

Работа с файлами также применима к аргументам по типу -H (подробнее о них можно узнать в [документации ByeDPI](https://github.com/hufrea/byedpi).
